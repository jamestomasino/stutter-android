...
data class AppearanceOptions(
    ...
    companion object {
        val DEFAULT = AppearanceOptions(
            ...
            leftColor = 0xFFFFFFFF.toInt(),
            centerColor = 0xFFFF3366.toInt(),
            remainderColor = 0xFFFFFFFF.toInt(),
            flankerColor = 0xFFB3B3B3.toInt(),
            buttonBackgroundColor = 0xFF222222.toInt(),
            buttonTextColor = 0xFF666666.toInt(),
            letterSpacingEm = 0f,
            paddingDp = 24f,
            boldCenter = false,
        )
